...
{
    std::filesystem::path libspath = "C:\\test\\mc";
    auto lib = MCLCPPLIB_NAMESPACE::SingleLibrary::getLibraryFromName(std::wstring(L"lox:sd:aa"), libspath);
...
{
    std::filesystem::path libspath = "C:\\test\\mc";
    auto lib = MCLCPPLIB_NAMESPACE::SingleLibrary::getLibraryFromName(std::u32string(U"lox:sd:aa"), libspath);
